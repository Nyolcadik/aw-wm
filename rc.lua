...
--                     title = "ooOops, there were errors during startup!",
...
--    awful.key({ modkey }, "p", function() menubar.show() end) -- Default M-p command, dmenu is a better/faster alternative
    ...
    awful.key({ modkey }, "e", function () awful.util.spawn_with_shell("spacefm") end)
)
...
-- add new Screesettings >VM-Ware
awful.util.spawn_with_shell("xrandr --newmode 1920x1080  173.00  1920 2048 2248 2576  1080 1083 1088 1120 -hsync +vsync")
awful.util.spawn_with_shell("xrandr --addmode Virtual1 1920x1080")
awful.util.spawn_with_shell("sleep 3 ; xrandr --output Virtual1 --mode 1920x1080")
-- autostart
